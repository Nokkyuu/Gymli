                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        //         const SizedBox(width: 8),
                        //         Text(
                        //           'Estimated calories: ${_calculateCalories().toStringAsFixed(1)}',
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: _buildStatCard(
                  'Total Calories',
                  '${(activityStats['total_calories'] ?? 0.0).toStringAsFixed(0)}',
              ...
              Expanded(
                child: _buildStatCard(
                  'Avg Duration',
                  '${(activityStats['average_duration'] ?? 0.0).toStringAsFixed(0)} min',
                  Icons.schedule,
                  Colors.purple,
                ),
              ),
          ...
          // Charts
          if (caloriesTrendData.isNotEmpty) ...[
            _buildChartCard(
            ...
            const SizedBox(height: 16),
            _buildChartCard(
              'Activity Duration (Last 30 Days)',
              _buildDurationChart(),
            ),
          ] else
            const Card(
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      'Log some activities to see your progress',
                      style: TextStyle(color: Colors.grey),
                    ),
                  ],
                ),
